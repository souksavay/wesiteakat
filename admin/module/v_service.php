              ...
              <div class="modal fade" id="modal-lg-New">
                <div class="modal-dialog modal-lg">
                  <div class="modal-content">
                    ...
                    <form method = "post" action="?d=module/service" enctype="multipart/form-data">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                   <?php
                   $i=1;
                    if ($result = $mysqli->query($qr_service)) {
                        while ($row = $result->fetch_row()) {
                          $serviceID = base64_encode($row[0]."tasoksavhay");
                          $headerVal = base64_encode($row[6]."tasoksavhay");
                   ...
                   ?>
                    ...
                    <tr>
                      ...
                      <td><a href="?d=module/service_detail&service=<?=$serviceID?>"><?=$row[1]?></a></td>
                      <td><?=$row[2]?></td>
                      <td><?=$row[4]?></td>
                      <td align="center">
                        <?php if ($row[6] == "1") {?>
                          <a href ="?d=module/service&service=<?=$serviceID?>&header=<?=$headerVal ?>&lang=<?=$GetLang?>" ><i class="far fa-check-square"></i></a>
                        <?php } else { ?>
                          <a href ="?d=module/service&service=<?=$serviceID?>&header=<?=$headerVal ?>&lang=<?=$GetLang?>" ><i class="fal fa-square-full"></i></a>
                        <?php } ?>
                      </td>                      
                      <td align="center">
                        <?php if ($row[5] == "1") {?>
                          <a href ="?d=module/service&service=<?=$serviceID?>&active=<?=$activeVal ?>&lang=<?=$GetLang?>" ><i class="far fa-check-square"></i></a>
                        <?php } else { ?>
                          <a href ="?d=module/service&service=<?=$serviceID?>&active=<?=$activeVal ?>&lang=<?=$GetLang?>" ><i class="fal fa-square-full"></i></a>
                        <?php } ?>
                      </td>
                      <td align="center"><a href="#"><i class="fas fa-edit" data-toggle="modal" data-target="#modal-lg-Edit<?=$i?>"></i></a></td>
                      <td align="center">
                        <a href ="?d=module/service&service=<?=$serviceID?>&del=<?=$activeVal ?>&lang=<?=$GetLang?>" onclick="return confirm('ທ່ານຕ້ອງການລຶບແທ້ບໍ...?')" ><i class="far fa-trash-alt"></i></a>
                      </td>
                    </tr>
                  <?php $i++; } } ?>
                  </tbody>
