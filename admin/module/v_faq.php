                ...
                <div class="modal-dialog modal-lg">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h4 class="modal-title">Faq Item</h4>
                      <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                      </button>
                    </div>
                    <form method = "post" action="?d=module/faq" enctype="multipart/form-data">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                   <?php
                   $i=1;
                    if ($result = $mysqli->query($qr_faq)) {
                        while ($row = $result->fetch_row()) {
                          $faqID = base64_encode($row[0]."tasoksavhay");
                   ...
                   ?>
                    ...
                    <tr>
                      ...
                      <td align="center">
                        <?php if ($row[6] == "1") {?>
                          <a href ="?d=module/faq&faq=<?=$faqID?>&header=<?=$headerVal ?>&lang=<?=$GetLang?>" ><i class="far fa-check-square"></i></a>
                        <?php } else { ?>
                          <a href ="?d=module/faq&faq=<?=$faqID?>&header=<?=$headerVal ?>&lang=<?=$GetLang?>" ><i class="fal fa-square-full"></i></a>
                        <?php } ?>
                      </td>                      
                      <td align="center">
                        <?php if ($row[5] == "1") {?>
                          <a href ="?d=module/faq&faq=<?=$faqID?>&active=<?=$activeVal ?>&lang=<?=$GetLang?>" ><i class="far fa-check-square"></i></a>
                        <?php } else { ?>
                          <a href ="?d=module/faq&faq=<?=$faqID?>&active=<?=$activeVal ?>&lang=<?=$GetLang?>" ><i class="fal fa-square-full"></i></a>
                        <?php } ?>
                      </td>
                      <td align="center"><a href="#"><i class="fas fa-edit" data-toggle="modal" data-target="#modal-lg-Edit<?=$i?>"></i></a></td>
                      <td align="center">
                        <a href ="?d=module/faq&faq=<?=$faqID?>&del=<?=$activeVal ?>&lang=<?=$GetLang?>" onclick="return confirm('ທ່ານຕ້ອງການລຶບແທ້ບໍ...?')" ><i class="far fa-trash-alt"></i></a>
                      </td>
                    </tr>
                  <?php $i++; } } ?>
                  </tbody>
