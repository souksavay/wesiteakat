                ...
                <div class="modal-dialog modal-lg">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h4 class="modal-title">Features Item</h4>
                      <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                      </button>
                    </div>
                    <form method = "post" action="?d=module/features" enctype="multipart/form-data">
                  ...
                  <tbody>
                   ...
                   $i=1;
                    if ($result = $mysqli->query($qr_feature)) {
                        while ($row = $result->fetch_row()) {
                          $featureID = base64_encode($row[0]."tasoksavhay");
                   ...
                   ?>
                    ...
                    <tr>
                      ...
                      <td align="center">
                        <?php if ($row[7] == "1") {?>
                          <a href ="?d=module/features&feature=<?=$featureID?>&header=<?=$headerVal ?>&lang=<?=$GetLang?>" ><i class="far fa-check-square"></i></a>
                        <?php } else { ?>
                          <a href ="?d=module/features&feature=<?=$featureID?>&header=<?=$headerVal ?>&lang=<?=$GetLang?>" ><i class="fal fa-square-full"></i></a>
                        <?php } ?>
                      </td>                      
                      <td align="center">
                        <?php if ($row[5] == "1") {?>
                          <a href ="?d=module/features&feature=<?=$featureID?>&active=<?=$activeVal ?>&lang=<?=$GetLang?>" ><i class="far fa-check-square"></i></a>
                        <?php } else { ?>
                          <a href ="?d=module/features&feature=<?=$featureID?>&active=<?=$activeVal ?>&lang=<?=$GetLang?>" ><i class="fal fa-square-full"></i></a>
                        <?php } ?>
                      </td>
                      <td align="center"><a href="#"><i class="fas fa-edit" data-toggle="modal" data-target="#modal-lg-Edit<?=$i?>"></i></a></td>
                      <td align="center">
                        <a href ="?d=module/features&feature=<?=$featureID?>&del=<?=$activeVal ?>&lang=<?=$GetLang?>" onclick="return confirm('ທ່ານຕ້ອງການລຶບແທ້ບໍ...?')" ><i class="far fa-trash-alt"></i></a>
                      </td>
                    </tr>
                  <?php $i++; } } ?>
                  </tbody>
