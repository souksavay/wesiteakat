            ...
            <div class="card">
              ...
              <div class="row"> 
                ...
                <div class="col-sm-6"><strong>
                  <?=$_SESSION['EGPOSAKATTeamDetailName']?></strong></div>
                </div>
              </div>
              <!-- /.card-header -->
                ...
                <div class="modal-dialog modal-lg">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h4 class="modal-title">Member detail Item</h4>
                      <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                      </button>
                    </div>
                    <form method = "post" action="?d=module/team_member_detail" enctype="multipart/form-data">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                   <?php
                   $i=1;
                    if ($result = $mysqli->query($qr_team_member_detail)) {
                        while ($row = $result->fetch_row()) {
                          $team_member_detailID = base64_encode($row[0]."tasoksavhay");                          
                          $activeVal = base64_encode($row[4]."tasoksavhay");
                   ...
                   ?>
                          ...
                          <div class="modal-body">                      
                              ...
                              <div class="row">
                                <div class="col-sm-12">                            
                                  ...
                                  <div class="form-group">
                                    <label>Title</label>
                                    <input type="text" name="txtTitle" class="form-control" placeholder="Enter ..." value="<?=$row[2]?>" required="">
                                  </div>                            
                                </div>                                                    
                              </div>
                              <div class="row">                                  
                    ...
                    <tr>
                      ...
                      <td align="center">
                        <?php if ($row[4] == "1") {?>
                          <a href ="?d=module/team_member_detail&team_member_detail=<?=$team_member_detailID?>&active=<?=$activeVal ?>&lang=<?=$GetLang?>" ><i class="far fa-check-square"></i></a>
                        <?php } else { ?>
                          <a href ="?d=module/team_member_detail&team_member_detail=<?=$team_member_detailID?>&active=<?=$activeVal ?>&lang=<?=$GetLang?>" ><i class="fal fa-square-full"></i></a>
                        <?php } ?>
                      </td>
                      <td align="center"><a href="#"><i class="fas fa-edit" data-toggle="modal" data-target="#modal-lg-Edit<?=$i?>"></i></a></td>
                      <td align="center">
                        <a href ="?d=module/team_member_detail&team_member_detail=<?=$team_member_detailID?>&del=<?=$activeVal ?>&lang=<?=$GetLang?>" onclick="return confirm('ທ່ານຕ້ອງການລຶບແທ້ບໍ...?')" ><i class="far fa-trash-alt"></i></a>
                      </td>
                    </tr>
                  <?php $i++; } } ?>
                  </tbody>
