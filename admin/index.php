...
<div class="wrapper">
     <!-- ##### Header Area Start ##### -->
    <?php if (file_exists("../admin/menu-header.php")) { include_once("../admin/menu-header.php"); } ?>
    <?php if (file_exists("../admin/menu-sidebar.php")) { include_once("../admin/menu-sidebar.php"); } ?>
    <!-- ##### Header Area End ##### -->   
    <!-- ##### Welcome Area Start ##### -->
